...
document.getElementById("button-exo1-p1").addEventListener("click", function () {
    ...
    if (checkCharacters(word) || word == "") {
        ...
        document.getElementById("result-exo1").innerHTML = "ce mot n'appartient pas au langages";
    }
});
...
document.getElementById("button-exo1-p2").addEventListener("click", function () {
    ...
    // if no, return "this word is not from the language"
    if (isNaN(n)) {
        document.getElementById("puissance").innerHTML = "Entrez un entier positif svp";
    } else {
        ...
        if (checkCharacters(word) || word == "") {
            ...
            document.getElementById("puissance").innerHTML = "Ce mot n'appartient pas au langages";
        }
    }
});
